...
def compare_framerates(frame_skips, vid_path, model_path):
	''' The function is for analyzing the effect of skipping frames on the total processing time and accuracy of the inference.
	
	Parameters
	----------
		frame_skips = list of number that represent how many frames are skipped between non skipped frames of the input video
